...
function navigate_back() {
    has_class(body, class_tracking_page) ? hide_tracking_page() : has_class(body, class_settings_page) && hide_settings_page(), has_class(body, class_explorer_page) && hide_explorer_page()
}
...
}), button_explorer.addEventListener("click",show_explorer_page),
